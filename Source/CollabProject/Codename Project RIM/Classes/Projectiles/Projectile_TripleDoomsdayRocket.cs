...
namespace Codename_Project_RIM
{
    public class Projectile_TripleDoomsdayRocket : Projectile
    {
        protected override void Impact(Thing hitThing)
        {
            ...
            GenExplosion.DoExplosion(base.Position, map, def.projectile.explosionRadius, DamageDefOf.Bomb, launcher, -1, -1f, null, equipmentDef, def);
        ...
        {
            ThingDef def = this.def;
            GenExplosion.DoExplosion(pos, map, radius, DamageDefOf.Flame, launcher, -1, -1f, null, this.equipmentDef, def, null, ThingDefOf.Snowman, 0.2f, 1);
        }
    }
